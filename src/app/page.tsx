          ...
          >
            ...
            <div className="relative z-10 flex flex-col h-full justify-between">
              ...
              <div className="mt-auto border-t border-emerald-50/50 pt-4">
                <h2 className="text-xl font-bold text-slate-800 group-hover:text-emerald-700 transition-colors">{surah.englishName}</h2>
                <div className="flex items-center justify-between mt-2">
                  <p className="text-xs text-slate-500 uppercase tracking-widest font-semibold bg-emerald-50 px-2 py-1 rounded-md">{surah.type}</p>
                  <p className="text-xs text-emerald-600 font-medium tracking-wide">{surah.verses.length} VERSES</p>
                </div>
              </div>
            </div>
          </Link>
